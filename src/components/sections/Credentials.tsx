    ...
    items: [
      {
        ...
        organization: "The ICFAI University, Jaipur",
        year: "2022–2026",
    ...
    items: [
      {
        ...
        year: "2024",
        description: "Database design, queries, and NoSQL architecture",
      },
      {
      ...
      },
      {
        ...
        year: "2025",
        description: "Court Case Priority Prediction System",
      },
      {
        title: "1st International Conference",
        organization: "ICFAI University",
        year: "2024",
        description: "Research on MCMC calibration for respiratory disorder models",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Quantum computing platform backend with AdonisJS, tRPC APIs",
      },
      {
        title: "Frontend Intern",
        organization: "Neocosmicx",
        year: "May–Jul 2024",
        description: "Built animated web UI with Next.js and Framer Motion",
      },
    ],
  },
];
